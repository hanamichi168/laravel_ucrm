...
<template>
    ...
    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
      <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
        ...
        <main class="modal__content" id="modal-1-content">
          <div v-if="customers.value" class="lg:w-full mx-auto overflow-auto">
  ...
  <button type="button" @click="searchCustomers" data-micromodal-trigger="modal-1" class="mt-4 flex mx-auto text-white bg-blue-400 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">
  検索する</button>
</template>